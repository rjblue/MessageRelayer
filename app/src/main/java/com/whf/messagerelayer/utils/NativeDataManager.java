...
public class NativeDataManager {
    ...
    public boolean getMissCallSwitch() {
        return mPreference.getBoolean(Constant.KEY_MISS_CALL, false);
    }

    public void setMissCallSwitch(boolean b) {
        mPreference.edit().putBoolean(Constant.KEY_MISS_CALL, b).apply();
    }
}